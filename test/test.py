...
async def test_a_b_c_even_parity_async(dut,seed):
    dut._log.info("Start Test: 3 Bit Even Parity (Async)")
    dut.uio_in.value = seed
    dut.ui_in.value = 0b00001000
    await ClockCycles(dut.clk,1)
    dut.ui_in.value = 0b00000000
...
async def test_a_b_c_one_hot_async(dut,seed):
    dut._log.info("Start Test: 3 Bit One Hot Detector (Async)")
    dut.uio_in.value = seed
    dut.ui_in.value = 0b00001000
    await ClockCycles(dut.clk,1)
    dut.ui_in.value = 0b00000000
